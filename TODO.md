...
**Punkt 8, Profil-Tab.** Echte Aggregate (Anzahl Workouts, Trainingsminuten, Gesamtvolumen) statt der aktuellen Platzhalter — `screenshots/Profile statistics.jpg` ist dafür eine Referenz. Damit wäre die komplette geplante Phase-2-Liste abgeschlossen.
